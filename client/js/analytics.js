(() => {
  ...
  function openPanel() {
    ...
    panel.innerHTML = `
      <div class="consent-copy">
        <p class="consent-kicker"><span aria-hidden="true"></span> Поверителност и статистика</p>
        <h2 id="consent-title">Помогни ни с анонимна статистика.</h2>
        <p>Използваме Google Analytics 4 само за обобщени посещения. Няма рекламно проследяване или персонализация, а PWA кешът не следи поведението ти.</p>
        <a href="/cookies">Научи повече за бисквитките</a>
      </div>
      <div class="consent-actions">
